...
const faqs = [
  {
    ...
    answer:
      "Payments made via GCash or PayPal are typically posted in real-time. However, please allow up to 24 hours for the system to fully update your balance. If it takes longer, please submit a ticket with your transaction reference number.",
  },
  {
    id: 2,
    category: "Water",
    ...
    answer:
      "You can submit a 'Service Request' directly from your Dashboard. Select 'Water Supply' as the category, take a photo of the leak, and pin the location. Our team usually responds within 2-4 hours for major leaks.",
  },
  {
    id: 3,
    category: "Account",
    ...
    answer:
      "Yes! Go to Profile > Linked Meters. You can add as many water or electric meter accounts as you manage (e.g., for your home, business, or rental properties).",
  },
  {
    id: 4,
    ...
    answer:
      "First, check if your consumption (kWh) has increased compared to last month. If the reading matches your meter but still seems wrong, you can request a 'Meter Re-calibration' through the Service Request tab.",
  },
  {
    id: 5,
    category: "Billing",
    ...
    answer:
      "Aside from the app, you can pay at the City Treasurer's Office (City Hall) or at any authorized Bayad Center in Mati City.",
  },
  {
    id: 6,
    category: "Water",
    ...
    answer:
      "Low water pressure can be caused by several factors: maintenance work in your area, pipeline issues, or problems with your property's plumbing. Check our announcements for scheduled maintenance. If the issue persists, submit a service request with details about when the problem started.",
  },
  {
    id: 7,
    category: "Electricity",
    ...
    answer:
      "First, check if the outage affects your entire neighborhood or just your property. Look for announcements about scheduled maintenance or emergency repairs. If it's isolated to your property, check your circuit breakers. For wider outages, we typically restore power within 2-6 hours depending on the issue.",
  },
  {
    id: 8,
    category: "Account",
    ...
    answer:
      "Click 'Forgot Password' on the login page and enter your registered email address. You'll receive a password reset link within 5 minutes. If you don't receive it, check your spam folder or contact support at support@mati.gov.ph.",
  },
  {
    id: 9,
    category: "Billing",
    ...
    answer:
      "Yes! You can enable auto-debit for your linked bank accounts or e-wallets. Go to Profile > Payment Settings > Auto-Pay. You'll receive a notification 3 days before each automatic payment is processed.",
  },
  {
    id: 10,
    category: "Water",
    ...
    answer:
      "Your water bill is based on your meter reading (cubic meters consumed) multiplied by the current rate per cubic meter, plus any applicable fees. The first 10 cubic meters are charged at a lower rate. You can view your consumption history and detailed breakdown in the Linked Meters section.",
  },
];
      ...
      >
        ...
        >
          <span class="font-semibold text-sm ${
            expandedFaq === faq.id ? "text-blue-700" : "text-slate-800"
          }">
...
function highlightSearchTerm(text) {
  ...
  return text.replace(
    regex,
    '<mark class="bg-yellow-200 text-slate-900">$1</mark>'
  );
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Navigation buttons
  document
    .getElementById("serviceAddressesBtn")
