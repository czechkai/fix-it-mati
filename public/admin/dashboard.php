  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex-shrink-0 hidden lg:flex flex-col">
      ...
      <nav class="flex-1 px-4 py-6 space-y-1" id="sidebarNav">
        <a href="/admin-dashboard.php" class="nav-item active w-full flex items-center justify-between px-3 py-3 rounded-lg text-sm font-medium transition-colors bg-blue-600 text-white shadow-md">
        ...
        <div id="viewOverview" class="view-content space-y-6">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="flex gap-2">
              ...
              <a href="/admin/service-requests.php" class="px-3 py-2 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 flex items-center gap-2 shadow-sm">
          ...
          <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="p-5 border-b border-slate-100 flex justify-between items-center">
              ...
              <a href="/admin/service-requests.php" class="text-sm text-blue-600 hover:underline font-medium">View All</a>
            </div>
