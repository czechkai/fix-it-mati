...
<body class="min-h-screen flex bg-white font-sans text-slate-800 overflow-hidden">
    ...
    <div
        class="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 relative overflow-hidden flex-col justify-between p-12 pb-10 text-white">
        ...
        <div class="relative z-10 max-w-lg">
            ...
            <div class="space-y-5">
                ...
                <div class="feature-card flex items-start gap-4 p-4 rounded-xl glass-effect">
                    <div
                        class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-amber-400 to-orange-500 rounded-lg flex items-center justify-center shadow-lg">
    ...
    <div
        class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 py-10 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 lg:bg-white h-screen">

        <div
            class="w-full max-w-md bg-white p-10 rounded-3xl shadow-xl border border-slate-100 lg:border-none lg:shadow-none lg:p-0">

            <!-- Mobile Logo (Visible only on small screens) -->
            <div class="lg:hidden flex justify-center mb-6">
                <div class="flex items-center gap-3 group">
                    <div
                        class="bg-gradient-to-br from-blue-600 to-blue-700 p-3 rounded-xl shadow-lg transform transition-transform group-hover:scale-105">
                        <i data-lucide="hammer" class="text-white w-6 h-6"></i>
                    </div>
                    <span
                        class="text-2xl font-bold bg-gradient-to-r from-blue-900 to-blue-700 bg-clip-text text-transparent">FixItMati</span>
                </div>
            </div>
            ...
            <!-- Error Message -->
            <div id="errorMessage"
                class="hidden mb-4 bg-red-50 border border-red-200 text-red-600 px-3 py-2 rounded-lg text-xs flex items-center gap-2 animate-fade-in">
            ...
            <div id="successMessage"
                class="hidden mb-4 bg-green-50 border border-green-200 text-green-600 px-3 py-2 rounded-lg text-xs flex items-center gap-2 animate-fade-in">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i data-lucide="mail"
                                class="h-4 w-4 text-slate-400 group-focus-within:text-blue-600 transition-colors duration-200"></i>
                        </div>
                ...
                <div class="space-y-1.5">
                    <div class="flex justify-between items-center ml-1">
                        ...
                        <a href="/forgot-password.php"
                            class="text-[10px] font-bold text-blue-600 hover:text-blue-700 hover:underline transition-colors">Forgot
                            password?</a>
                    </div>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div class="mt-6 text-center">
                <p class="text-xs text-slate-600">
                    ...
                    <a href="/register.php"
                        class="font-bold text-blue-600 hover:text-blue-700 hover:underline transition-colors">
