          ...
          <div class="relative">
            ...
            <div id="profileDropdown" class="hidden absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-slate-200 z-50">
              ...
              <div class="p-2 border-t border-slate-100">
                <button id="logoutBtn" onclick="sessionStorage.clear(); window.location.href='logout.php';" class="w-full flex items-center gap-3 px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-md transition-colors">
      ...
      <div class="w-full lg:w-64 flex-shrink-0">
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden sticky top-24">
          <nav class="flex flex-col" id="settingsTabs">
            ...
            <button onclick="sessionStorage.clear(); window.location.href='logout.php';" class="flex items-center gap-3 px-4 py-3.5 text-sm font-medium text-red-600 hover:bg-red-50 border-l-4 border-transparent transition-colors">
